...
VASignalBuffer* VASignalBufferManager::getBufferByFileName(FString fileName_)
{
	...
	if (!buffers.Num())
	{
		for (auto entry : buffers)
		{
			...
			{
				FString output = "[VASignalBufferManager::getBufferByFileName()] Buffer from file " + fileName_ +
					" was found!";
	...
	VAUtils::logStuff(
		"[VASignalBufferManager::getBufferByFileName()] Buffer from file " + fileName_ +
